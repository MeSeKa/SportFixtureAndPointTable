...
namespace SportFixtureAndPointTable.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(SportFixtureAndPointsTableDBContext context)
        {
            _context = context;
        }
        ...
        {
            var sportFixtureAndPointsTableDBContext = _context.Players.Include(p => p.Team);
        ...
        public async Task<IActionResult> Create([Bind("PlayerName,TeamId,Position")] Player player)
        {
            ...
            var teams = _context.Teams.Select(t => new { t.TeamId, t.TeamName }).ToList();
            ViewBag.Teams = new SelectList(teams, "TeamID", "TeamName");
            return View(player);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PlayerName,TeamId,Position")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
